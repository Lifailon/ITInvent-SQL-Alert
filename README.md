...
За основу беру [медот оповещений из Excel](https://github.com/Lifailon/Excel-Date-Report), в данном случае будем осуществлять отправку в **Telegram**, применяется четыре тригерных значения: 30, 14, 7 и 3 дня.
